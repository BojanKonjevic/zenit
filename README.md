...
A FastAPI project generated by v1.1.1 with Docker, SQLAlchemy, Postgres, and Redis:

```bash
zenit create demo-api --template fastapi -a docker,sqlalchemy,postgres,redis
```

<!-- TODO: push the generated repo and link it here -->
...
Published on [PyPI](https://pypi.org/project/zenit/) at v1.1.1. Strict `mypy`, `ruff` clean, 1,300+ tests green in CI on Ubuntu and Windows across Python 3.12 to 3.14. See [CHANGELOG](CHANGELOG.md).
